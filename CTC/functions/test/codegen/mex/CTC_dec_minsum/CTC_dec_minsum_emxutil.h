/*
 * CTC_dec_minsum_emxutil.h
 *
 * Code generation for function 'CTC_dec_minsum_emxutil'
 *
 */

#ifndef __CTC_DEC_MINSUM_EMXUTIL_H__
#define __CTC_DEC_MINSUM_EMXUTIL_H__
...
/* End of code generation (CTC_dec_minsum_emxutil.h) */
